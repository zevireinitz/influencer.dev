...
**influencer.dev is the marketplace for developer-focused content creators.** 

**We're helping the creators showcase their work, and we're helping the companies/brands find creators to fit their needs**

- **CREATORS:** To get added to the list of content creators, follow these steps:
  1. [Open a Github issue with your information](https://github.com/zevireinitz/influencer.dev/issues/new?assignees=&labels=profile&projects=&template=profile.yml&title=Add+my+name+to+the+list+-+%3Cyour+name%3E) so we can add you to the list.
  ...
  3. ⭐ Star this repo (so that more people can find this list)

- **COMPANIES:** To promote a project/opportunity on our (closed) content creator community/email follow these steps:
  1. [Tell us your about your upcoming project(s)](https://forms.gle/by3po2Qa2X8qptEr8)
  2. ⭐ Star this repo 
...
| <img src="https://github.com/xkrishguptaa.png" width="100" > | [Krish Gupta](https://github.com/xkrishguptaa) | `Open Source` `DevOps` `Dev Tools` `Docker` | 5k | [![Twitter](https://github.com/zevireinitz/influencer.dev/assets/92805730/7bd41f37-435a-4788-8103-5ae1e7dda54b)](https://twitter.com/xkrishguptaa) <br> [![LI](https://github.com/zevireinitz/influencer.dev/assets/92805730/9ca0bf48-e9f6-47ac-b354-ecc0d6385056)](https://linkedin.com/in/xkrishguptaa) | [Portfolio](https://xkrish.co/) |
...
Simply put - dev-focued content creators are important because developers appreciate _**authenticity**_. 
